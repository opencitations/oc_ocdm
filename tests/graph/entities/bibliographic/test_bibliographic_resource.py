...
class TestBibliographicResource(unittest.TestCase):
    ...
    def test_is_part_of(self):
        ...
        triple = self.br1.res, GraphEntity.iri_part_of, RDFTerm("uri", str(self.br2.res))
        self.assertIn(triple, self.br1.g)
    ...
    def test_has_citation(self):
        ...
        triple = self.br1.res, GraphEntity.iri_cites, RDFTerm("uri", str(self.br2.res))
        self.assertIn(triple, self.br1.g)
    ...
    def test_has_format(self):
        ...
        triple = self.br1.res, GraphEntity.iri_embodiment, RDFTerm("uri", str(self.re.res))
        self.assertIn(triple, self.br1.g)
    ...
    def test_contains_in_reference_list(self):
        ...
        triple = self.br1.res, GraphEntity.iri_contains_reference, RDFTerm("uri", str(self.be.res))
        self.assertIn(triple, self.br1.g)
    ...
    def test_contains_discourse_element(self):
        ...
        triple = self.br1.res, GraphEntity.iri_contains_de, RDFTerm("uri", str(self.de.res))
        self.assertIn(triple, self.br1.g)
    ...
    def test_has_contributor(self):
        ...
        triple = self.br1.res, GraphEntity.iri_is_document_context_for, RDFTerm("uri", str(self.ar.res))
        self.assertIn(triple, self.br1.g)
    ...
    def test_has_related_document(self):
        ...
        triple = self.br1.res, GraphEntity.iri_relation, RDFTerm("uri", str(document))
        self.assertIn(triple, self.br1.g)
